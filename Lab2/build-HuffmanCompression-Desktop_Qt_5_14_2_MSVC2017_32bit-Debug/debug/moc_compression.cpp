...
#include <memory>
#include "../../HuffmanCompression/compression.h"
...
QT_MOC_LITERAL(3, 19, 8), // "mysignal"
QT_MOC_LITERAL(4, 28, 3) // "per"

    },
    "Compression\0error\0\0mysignal\0per"
};
...
void Compression::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->mysignal((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Compression::error)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Compression::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Compression::mysignal)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Compression::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_Compression.data,
...
// SIGNAL 1
void Compression::mysignal(double _t1)
{
